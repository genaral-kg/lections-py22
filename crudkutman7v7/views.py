...
class ListingMixin(GetMixin):
    ...
    def listing_products(self):
        ...
        for obj in data:
            print('Id :', obj['id'])
            print('Марка :', obj['brand'])
            print('Модель :', obj['model'])
            print('Год выпуска :', obj['year_of_manufacture'])
            print('Объем двигателя :',obj['engine_size'])
            print('Цвет :',obj['color'])
            print('Тип кузова :',obj['body_type'])
            print('Пробег :',obj['mileage'])
            print('Цена :', obj['price'])
            print()
        return ''
